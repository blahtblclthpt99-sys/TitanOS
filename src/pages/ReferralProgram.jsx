...
import { REFERRAL_REWARD, betaBadgeLabel, isFreeDuringBeta } from "@/lib/plan";

/** Live referral program UI — shown only when `referrals` feature flag is on. */
  ...
  return (
    <div className="p-4 md:p-8 max-w-3xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-5">
        ...
        <ReferralList title="Successful paying referrals" icon={CheckCircle2} rows={stats.paying} empty={isFreeDuringBeta() ? "Verified paying referrals begin after launch." : "No verified paying referrals yet."} successful />
      </div>
