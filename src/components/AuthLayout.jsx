...
export default function AuthLayout({ title, subtitle, children, footer }) {
  ...
  return (
    <div
      className="auth-shell min-h-dvh flex items-center justify-center px-4 py-10 bg-[#F8FAFC] text-slate-900"
      style={{
    ...
    >
      <div className="w-full max-w-[420px]">
        <div className="auth-card bg-white rounded-2xl shadow-[0_10px_40px_rgba(15,23,42,0.08)] border border-slate-200/80 p-6 sm:p-10">
