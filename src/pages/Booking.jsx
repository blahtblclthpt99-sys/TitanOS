  ...
  return <div className="p-4 md:p-8 max-w-5xl mx-auto pb-28">
    ...
    <div className="grid lg:grid-cols-[1.3fr_.7fr] gap-5">
      <form onSubmit={savePage} className="glass rounded-3xl p-5 md:p-7 border border-border space-y-4">
        ...
        <label className="flex items-center gap-2 text-sm text-foreground/85"><input type="checkbox" checked={!!form.accepts_same_day} onChange={(e) => update("accepts_same_day", e.target.checked)} className="accent-cyan-400" /> Accept same-day requests</label>
