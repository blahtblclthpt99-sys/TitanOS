...
/**
 * Tables required before TitanOS may run mutation-based live DB security
 * verification. This intentionally includes representative application tables
 * and every server/security table the current verifier depends on.
 */
