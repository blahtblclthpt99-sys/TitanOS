...
const LEGACY_CLEANUP_KEY = "titan-attention:legacy-client-cleanup-v1";
...
async function purgeLegacyClientStateOnce() {
  ...
  try {
    ...
    // Best effort. If cleanup cannot complete, retry on a later launch.
  }
}

void purgeLegacyClientStateOnce();
