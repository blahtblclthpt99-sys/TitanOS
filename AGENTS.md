...
- Fine-tooth rule: inspect architecture, correctness, security, data integrity, edge cases, concurrency, UX/a11y, performance, tests, and deployment risk before declaring work complete (see `.cursor/rules/fine-tooth-perfectionist.mdc`).
